...
2. Open the **SkyscanReconImport** module, set **Choose log file from image series** to `png_recon/left_side_damaged__rec.log`, and click **Apply**. The skull is loaded as the volume `left_side_damaged__rec` (444 × 444 × 488 voxels of 0.035 mm). See the [SkyscanReconImport tutorial](../SkyscanReconImport/README.md) for details.
